...
def generar_sql():
    # 1. Cargar los CSVs
    df_vab = pd.read_csv("csv/vab_por_provincias_2018_2021_limpio.csv")
    df_infra = pd.read_csv("csv/dataset_limpio_2021_caracteristicas.csv")
    df_evo = pd.read_csv("csv/cant-esteducativos.csv")
    ...
    with open('initdb/02_inserts.sql', 'w', encoding='utf-8') as f:
        f.write('\n'.join(sql_lines))
